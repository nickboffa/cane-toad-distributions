...
```{r}
unique_points <- anti_join(toads, clean, by = c("decimalLongitude", "decimalLatitude"))

# Plot the data
ggplot() +
  geom_point(data = toads, aes(x = decimalLongitude, y = decimalLatitude), color = "black") +
  geom_point(data = unique_points, aes(x = decimalLongitude, y = decimalLatitude), color = "red") +
  xlim(100, 160) +
  ylim(-40, -5)
```
...
## Select useful columns and write to file
